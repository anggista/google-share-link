var KeyBungabdi = KeyBungabdi || function (t, e) {
    var r = {},
        n = r.lib = {},
        i = n.Base = function () {
            function t() {}
...
}(), KeyBungabdi.lib.Cipher || function (t) {
        var e = KeyBungabdi,
            r = e.lib,
            n = r.Base,
            i = r.WordArray,
            ...
            u = r.Cipher = o.extend({
                cfg: n.extend(),
                createamankanor: function (t, e) {
                    return this.create(this._ENC_XFORM_MODE, t, e)
                },
                createbukaor: function (t, e) {
                ...
                _createHelper: function () {
                    ...
                    return function (e) {
                        return {
                            amankan: function (r, n, i) {
                                return t(n).amankan(e, r, n, i)
                            },
                            buka: function (r, n, i) {
                                return t(n).buka(e, r, n, i)
                            }
                        }
                    }
                }()
            ...
            p = r.BlockCipherMode = n.extend({
                createamankanor: function (t, e) {
                    return this.amankanor.create(t, e)
                },
                createbukaor: function (t, e) {
                    return this.bukaor.create(t, e)
                },
                init: function (t, e) {
            ...
            l = h.CBC = function () {
                ...
                var r = p.extend();
                return r.amankanor = r.extend({
                    processBlock: function (t, r) {
                        var n = this._cipher,
                            i = n.blockSize;
                        e.call(this, t, r, i), n.amankanBlock(t, r), this._prevBlock = t.slice(r, r + i)
                    }
                }), r.bukaor = r.extend({
                    processBlock: function (t, r) {
                        var n = this._cipher,
                            i = n.blockSize,
                            o = t.slice(r, r + i);
                        n.bukaBlock(t, r), e.call(this, t, r, i), this._prevBlock = o
                    }
                }), r
            }(),
            d = e.pad = {},
            ...
            y = (r.BlockCipher = u.extend({
                ...
                reset: function () {
                    ...
                    var t = this.cfg,
                        e = t.iv,
                        r = t.mode;
                    if (this._xformMode == this._ENC_XFORM_MODE) var n = r.createamankanor;
                    else {
                        var n = r.createbukaor;
            ...
            m = r.SerializableCipher = n.extend({
                ...
                amankan: function (t, e, r, n) {
                    n = this.cfg.extend(n);
                    var i = t.createamankanor(r, n),
                        o = i.finalize(e),
                        s = i.cfg;
                    return y.create({
                        ciphertext: o,
                ...
                buka: function (t, e, r, n) {
                    n = this.cfg.extend(n), e = this._parse(e, n.format);
                    var i = t.createbukaor(r, n).finalize(e.ciphertext);
                    return i
                },
                _parse: function (t, e) {
            ...
            x = r.PasswordBasedCipher = m.extend({
                ...
                amankan: function (t, e, r, n) {
                    ...
                    n.iv = i.iv;
                    var o = m.amankan.call(this, t, e, i.key, n);
                    return o.mixIn(i), o
                },
                buka: function (t, e, r, n) {
                    n = this.cfg.extend(n), e = this._parse(e, n.format);
                    ...
                    n.iv = i.iv;
                    var o = m.buka.call(this, t, e, i.key, n);
                    return o
                }
            })
    }(),
...
! function (t) {
    ...
    t.formatter = {
        ...
        parse: function (t) {
            var e = KeyBungabdi.lib.CipherParams.create({}),
                r = this.prefix.length;
            return 0 !== t.indexOf(this.prefix) ? e : (e.ciphertext = KeyBungabdi.enc.Hex.parse(t.substring(16 + r)), e.salt = KeyBungabdi.enc.Hex.parse(t.substring(r, 16 + r)), e)
        }
    }, t.amankan = function (e, r) {
        try {
            return KeyBungabdi.ABDI.amankan(e, r, {
                format: t.formatter
            }).toString()
        } catch (n) {
            return ""
        ...
        try {
            var n = KeyBungabdi.ABDI.buka(e, r, {
                format: t.formatter
            });
            return n.toString(KeyBungabdi.enc.Utf8)
        } catch (i) {
            return ""
        }
    }
